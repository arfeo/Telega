...
public:
    ...
    virtual qint64 accountRegisterDevice(qint32 token_type, const QString &token, qint32 timeout = timeOut());
    virtual qint64 accountUnregisterDevice(qint32 token_type, const QString &token, qint32 timeout = timeOut());
    virtual qint64 accountUpdateNotifySettings(const InputNotifyPeer &peer, const InputPeerNotifySettings &settings, qint32 timeout = timeOut());
    virtual qint64 accountGetNotifySettings(const InputNotifyPeer &peer, qint32 timeout = timeOut());
    virtual qint64 accountResetNotifySettings(qint32 timeout = timeOut());
    virtual qint64 accountUpdateProfile(const QString &first_name, const QString &last_name, const QString &about, qint32 timeout = timeOut());
    virtual qint64 accountUpdateStatus(bool offline, qint32 timeout = timeOut());
    virtual qint64 accountGetWallPapers(qint32 timeout = timeOut());
    virtual qint64 accountReportPeer(const InputPeer &peer, const ReportReason &reason, qint32 timeout = timeOut());
    virtual qint64 accountCheckUsername(const QString &username, qint32 timeout = timeOut());
    virtual qint64 accountUpdateUsername(const QString &username, qint32 timeout = timeOut());
    virtual qint64 accountGetPrivacy(const InputPrivacyKey &key, qint32 timeout = timeOut());
    virtual qint64 accountSetPrivacy(const InputPrivacyKey &key, const QList<InputPrivacyRule> &rules, qint32 timeout = timeOut());
    virtual qint64 accountDeleteAccount(const QString &reason, qint32 timeout = timeOut());
    virtual qint64 accountGetAccountTTL(qint32 timeout = timeOut());
    virtual qint64 accountSetAccountTTL(const AccountDaysTTL &ttl, qint32 timeout = timeOut());
    virtual qint64 accountSendChangePhoneCode(bool allow_flashcall, const QString &phone_number, bool current_number, qint32 timeout = timeOut());
    virtual qint64 accountChangePhone(const QString &phone_number, const QString &phone_code_hash, const QString &phone_code, qint32 timeout = timeOut());
    virtual qint64 accountUpdateDeviceLocked(qint32 period, qint32 timeout = timeOut());
    virtual qint64 accountGetAuthorizations(qint32 timeout = timeOut());
    virtual qint64 accountResetAuthorization(qint64 hash, qint32 timeout = timeOut());
    virtual qint64 accountGetPassword(qint32 timeout = timeOut());
    virtual qint64 accountGetPasswordSettings(const QByteArray &current_password_hash, qint32 timeout = timeOut());
    virtual qint64 accountUpdatePasswordSettings(const QByteArray &current_password_hash, const AccountPasswordInputSettings &new_settings, qint32 timeout = timeOut());
    virtual qint64 accountSendConfirmPhoneCode(bool allow_flashcall, const QString &hash, bool current_number, qint32 timeout = timeOut());
    virtual qint64 accountConfirmPhone(const QString &phone_code_hash, const QString &phone_code, qint32 timeout = timeOut());
    virtual qint64 accountGetTmpPassword(const QByteArray &password_hash, qint32 period, qint32 timeout = timeOut());

    virtual qint64 authCheckPhone(const QString &phone_number, qint32 timeout = timeOut());
    virtual qint64 authSendCode(bool allow_flashcall, const QString &phone_number, bool current_number, qint32 api_id, const QString &api_hash, qint32 timeout = timeOut());
    virtual qint64 authSignUp(const QString &phone_number, const QString &phone_code_hash, const QString &phone_code, const QString &first_name, const QString &last_name, qint32 timeout = timeOut());
    virtual qint64 authSignIn(const QString &phone_number, const QString &phone_code_hash, const QString &phone_code, qint32 timeout = timeOut());
    virtual qint64 authLogOut(qint32 timeout = timeOut());
    virtual qint64 authResetAuthorizations(qint32 timeout = timeOut());
    virtual qint64 authSendInvites(const QList<QString> &phone_numbers, const QString &message, qint32 timeout = timeOut());
    virtual qint64 authExportAuthorization(qint32 dc_id, qint32 timeout = timeOut());
    virtual qint64 authImportAuthorization(qint32 id, const QByteArray &bytes, qint32 timeout = timeOut());
    virtual qint64 authBindTempAuthKey(qint64 perm_auth_key_id, qint64 nonce, qint32 expires_at, const QByteArray &encrypted_message, qint32 timeout = timeOut());
    virtual qint64 authImportBotAuthorization(qint32 flags, qint32 api_id, const QString &api_hash, const QString &bot_auth_token, qint32 timeout = timeOut());
    virtual qint64 authCheckPassword(const QByteArray &password_hash, qint32 timeout = timeOut());
    virtual qint64 authRequestPasswordRecovery(qint32 timeout = timeOut());
    virtual qint64 authRecoverPassword(const QString &code, qint32 timeout = timeOut());
    virtual qint64 authResendCode(const QString &phone_number, const QString &phone_code_hash, qint32 timeout = timeOut());
    virtual qint64 authCancelCode(const QString &phone_number, const QString &phone_code_hash, qint32 timeout = timeOut());
    virtual qint64 authDropTempAuthKeys(const QList<qint64> &except_auth_keys, qint32 timeout = timeOut());

    virtual qint64 botsSendCustomRequest(const QString &custom_method, const DataJSON &params, qint32 timeout = timeOut());
    virtual qint64 botsAnswerWebhookJSONQuery(qint64 query_id, const DataJSON &data, qint32 timeout = timeOut());

    virtual qint64 channelsReadHistory(const InputChannel &channel, qint32 max_id, qint32 timeout = timeOut());
    virtual qint64 channelsDeleteMessages(const InputChannel &channel, const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 channelsDeleteUserHistory(const InputChannel &channel, const InputUser &user_id, qint32 timeout = timeOut());
    virtual qint64 channelsReportSpam(const InputChannel &channel, const InputUser &user_id, const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 channelsGetMessages(const InputChannel &channel, const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 channelsGetParticipants(const InputChannel &channel, const ChannelParticipantsFilter &filter, qint32 offset, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 channelsGetParticipant(const InputChannel &channel, const InputUser &user_id, qint32 timeout = timeOut());
    virtual qint64 channelsGetChannels(const QList<InputChannel> &id, qint32 timeout = timeOut());
    virtual qint64 channelsGetFullChannel(const InputChannel &channel, qint32 timeout = timeOut());
    virtual qint64 channelsCreateChannel(bool broadcast, bool megagroup, const QString &title, const QString &about, qint32 timeout = timeOut());
    virtual qint64 channelsEditAbout(const InputChannel &channel, const QString &about, qint32 timeout = timeOut());
    virtual qint64 channelsEditAdmin(const InputChannel &channel, const InputUser &user_id, const ChannelAdminRights &admin_rights, qint32 timeout = timeOut());
    virtual qint64 channelsEditTitle(const InputChannel &channel, const QString &title, qint32 timeout = timeOut());
    virtual qint64 channelsEditPhoto(const InputChannel &channel, const InputChatPhoto &photo, qint32 timeout = timeOut());
    virtual qint64 channelsCheckUsername(const InputChannel &channel, const QString &username, qint32 timeout = timeOut());
    virtual qint64 channelsUpdateUsername(const InputChannel &channel, const QString &username, qint32 timeout = timeOut());
    virtual qint64 channelsJoinChannel(const InputChannel &channel, qint32 timeout = timeOut());
    virtual qint64 channelsLeaveChannel(const InputChannel &channel, qint32 timeout = timeOut());
    virtual qint64 channelsInviteToChannel(const InputChannel &channel, const QList<InputUser> &users, qint32 timeout = timeOut());
    virtual qint64 channelsExportInvite(const InputChannel &channel, qint32 timeout = timeOut());
    virtual qint64 channelsDeleteChannel(const InputChannel &channel, qint32 timeout = timeOut());
    virtual qint64 channelsToggleInvites(const InputChannel &channel, bool enabled, qint32 timeout = timeOut());
    virtual qint64 channelsExportMessageLink(const InputChannel &channel, qint32 id, qint32 timeout = timeOut());
    virtual qint64 channelsToggleSignatures(const InputChannel &channel, bool enabled, qint32 timeout = timeOut());
    virtual qint64 channelsUpdatePinnedMessage(bool silent, const InputChannel &channel, qint32 id, qint32 timeout = timeOut());
    virtual qint64 channelsGetAdminedPublicChannels(qint32 timeout = timeOut());
    virtual qint64 channelsEditBanned(const InputChannel &channel, const InputUser &user_id, const ChannelBannedRights &banned_rights, qint32 timeout = timeOut());
    virtual qint64 channelsGetAdminLog(const InputChannel &channel, const QString &q, const ChannelAdminLogEventsFilter &events_filter, const QList<InputUser> &admins, qint64 max_id, qint64 min_id, qint32 limit, qint32 timeout = timeOut());

    virtual qint64 contactsGetStatuses(qint32 timeout = timeOut());
    virtual qint64 contactsGetContacts(const QString &hash, qint32 timeout = timeOut());
    virtual qint64 contactsImportContacts(const QList<InputContact> &contacts, bool replace, qint32 timeout = timeOut());
    virtual qint64 contactsDeleteContact(const InputUser &id, qint32 timeout = timeOut());
    virtual qint64 contactsDeleteContacts(const QList<InputUser> &id, qint32 timeout = timeOut());
    virtual qint64 contactsBlock(const InputUser &id, qint32 timeout = timeOut());
    virtual qint64 contactsUnblock(const InputUser &id, qint32 timeout = timeOut());
    virtual qint64 contactsGetBlocked(qint32 offset, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 contactsExportCard(qint32 timeout = timeOut());
    virtual qint64 contactsImportCard(const QList<qint32> &export_card, qint32 timeout = timeOut());
    virtual qint64 contactsSearch(const QString &q, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 contactsResolveUsername(const QString &username, qint32 timeout = timeOut());
    virtual qint64 contactsGetTopPeers(bool correspondents, bool bots_pm, bool bots_inline, bool phone_calls, bool groups, bool channels, qint32 offset, qint32 limit, qint32 hash, qint32 timeout = timeOut());
    virtual qint64 contactsResetTopPeerRating(const TopPeerCategory &category, const InputPeer &peer, qint32 timeout = timeOut());

    virtual qint64 helpGetConfig(qint32 timeout = timeOut());
    virtual qint64 helpGetNearestDc(qint32 timeout = timeOut());
    virtual qint64 helpGetAppUpdate(qint32 timeout = timeOut());
    virtual qint64 helpSaveAppLog(const QList<InputAppEvent> &events, qint32 timeout = timeOut());
    virtual qint64 helpGetInviteText(qint32 timeout = timeOut());
    virtual qint64 helpGetSupport(qint32 timeout = timeOut());
    virtual qint64 helpGetAppChangelog(const QString &prev_app_version, qint32 timeout = timeOut());
    virtual qint64 helpGetTermsOfService(qint32 timeout = timeOut());
    virtual qint64 helpSetBotUpdatesStatus(qint32 pending_updates_count, const QString &message, qint32 timeout = timeOut());
    virtual qint64 helpGetCdnConfig(qint32 timeout = timeOut());

    virtual qint64 langpackGetLangPack(const QString &lang_code, qint32 timeout = timeOut());
    virtual qint64 langpackGetStrings(const QString &lang_code, const QList<QString> &keys, qint32 timeout = timeOut());
    virtual qint64 langpackGetDifference(qint32 from_version, qint32 timeout = timeOut());
    virtual qint64 langpackGetLanguages(qint32 timeout = timeOut());

    virtual qint64 messagesGetMessages(const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 messagesGetDialogs(bool exclude_pinned, qint32 offset_date, qint32 offset_id, const InputPeer &offset_peer, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 messagesGetHistory(const InputPeer &peer, qint32 offset_id, qint32 offset_date, qint32 add_offset, qint32 limit, qint32 max_id, qint32 min_id, qint32 timeout = timeOut());
    virtual qint64 messagesSearch(const InputPeer &peer, const QString &q, const InputUser &from_id, const MessagesFilter &filter, qint32 min_date, qint32 max_date, qint32 offset, qint32 max_id, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 messagesReadHistory(const InputPeer &peer, qint32 max_id, qint32 timeout = timeOut());
    virtual qint64 messagesDeleteHistory(bool just_clear, const InputPeer &peer, qint32 max_id, qint32 timeout = timeOut());
    virtual qint64 messagesDeleteMessages(bool revoke, const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 messagesReceivedMessages(qint32 max_id, qint32 timeout = timeOut());
    virtual qint64 messagesSetTyping(const InputPeer &peer, const SendMessageAction &action, qint32 timeout = timeOut());
    virtual qint64 messagesSendMessage(bool no_webpage, bool silent, bool background, bool clear_draft, const InputPeer &peer, qint32 reply_to_msg_id, const QString &message, qint64 random_id, const ReplyMarkup &reply_markup, const QList<MessageEntity> &entities, qint32 timeout = timeOut());
    virtual qint64 messagesSendMedia(bool silent, bool background, bool clear_draft, const InputPeer &peer, qint32 reply_to_msg_id, const InputMedia &media, qint64 random_id, const ReplyMarkup &reply_markup, qint32 timeout = timeOut());
    virtual qint64 messagesForwardMessages(bool silent, bool background, bool with_my_score, const InputPeer &from_peer, const QList<qint32> &id, const QList<qint64> &random_id, const InputPeer &to_peer, qint32 timeout = timeOut());
    virtual qint64 messagesReportSpam(const InputPeer &peer, qint32 timeout = timeOut());
    virtual qint64 messagesHideReportSpam(const InputPeer &peer, qint32 timeout = timeOut());
    virtual qint64 messagesGetPeerSettings(const InputPeer &peer, qint32 timeout = timeOut());
    virtual qint64 messagesGetChats(const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 messagesGetFullChat(qint32 chat_id, qint32 timeout = timeOut());
    virtual qint64 messagesEditChatTitle(qint32 chat_id, const QString &title, qint32 timeout = timeOut());
    virtual qint64 messagesEditChatPhoto(qint32 chat_id, const InputChatPhoto &photo, qint32 timeout = timeOut());
    virtual qint64 messagesAddChatUser(qint32 chat_id, const InputUser &user_id, qint32 fwd_limit, qint32 timeout = timeOut());
    virtual qint64 messagesDeleteChatUser(qint32 chat_id, const InputUser &user_id, qint32 timeout = timeOut());
    virtual qint64 messagesCreateChat(const QList<InputUser> &users, const QString &title, qint32 timeout = timeOut());
    virtual qint64 messagesForwardMessage(const InputPeer &peer, qint32 id, qint64 random_id, qint32 timeout = timeOut());
    virtual qint64 messagesGetDhConfig(qint32 version, qint32 random_length, qint32 timeout = timeOut());
    virtual qint64 messagesRequestEncryption(const InputUser &user_id, qint32 random_id, const QByteArray &g_a, qint32 timeout = timeOut());
    virtual qint64 messagesAcceptEncryption(const InputEncryptedChat &peer, const QByteArray &g_b, qint64 key_fingerprint, qint32 timeout = timeOut());
    virtual qint64 messagesDiscardEncryption(qint32 chat_id, qint32 timeout = timeOut());
    virtual qint64 messagesSetEncryptedTyping(const InputEncryptedChat &peer, bool typing, qint32 timeout = timeOut());
    virtual qint64 messagesReadEncryptedHistory(const InputEncryptedChat &peer, qint32 max_date, qint32 timeout = timeOut());
    virtual qint64 messagesSendEncrypted(const InputEncryptedChat &peer, qint64 random_id, const QByteArray &data, qint32 timeout = timeOut());
    virtual qint64 messagesSendEncryptedFile(const InputEncryptedChat &peer, qint64 random_id, const QByteArray &data, const InputEncryptedFile &file, qint32 timeout = timeOut());
    virtual qint64 messagesSendEncryptedService(const InputEncryptedChat &peer, qint64 random_id, const QByteArray &data, qint32 timeout = timeOut());
    virtual qint64 messagesReceivedQueue(qint32 max_qts, qint32 timeout = timeOut());
    virtual qint64 messagesReportEncryptedSpam(const InputEncryptedChat &peer, qint32 timeout = timeOut());
    virtual qint64 messagesReadMessageContents(const QList<qint32> &id, qint32 timeout = timeOut());
    virtual qint64 messagesGetAllStickers(qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesGetWebPagePreview(const QString &message, qint32 timeout = timeOut());
    virtual qint64 messagesExportChatInvite(qint32 chat_id, qint32 timeout = timeOut());
    virtual qint64 messagesCheckChatInvite(const QString &hash, qint32 timeout = timeOut());
    virtual qint64 messagesImportChatInvite(const QString &hash, qint32 timeout = timeOut());
    virtual qint64 messagesGetStickerSet(const InputStickerSet &stickerset, qint32 timeout = timeOut());
    virtual qint64 messagesInstallStickerSet(const InputStickerSet &stickerset, bool archived, qint32 timeout = timeOut());
    virtual qint64 messagesUninstallStickerSet(const InputStickerSet &stickerset, qint32 timeout = timeOut());
    virtual qint64 messagesStartBot(const InputUser &bot, const InputPeer &peer, qint64 random_id, const QString &start_param, qint32 timeout = timeOut());
    virtual qint64 messagesGetMessagesViews(const InputPeer &peer, const QList<qint32> &id, bool increment, qint32 timeout = timeOut());
    virtual qint64 messagesToggleChatAdmins(qint32 chat_id, bool enabled, qint32 timeout = timeOut());
    virtual qint64 messagesEditChatAdmin(qint32 chat_id, const InputUser &user_id, bool is_admin, qint32 timeout = timeOut());
    virtual qint64 messagesMigrateChat(qint32 chat_id, qint32 timeout = timeOut());
    virtual qint64 messagesSearchGlobal(const QString &q, qint32 offset_date, const InputPeer &offset_peer, qint32 offset_id, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 messagesReorderStickerSets(bool masks, const QList<qint64> &order, qint32 timeout = timeOut());
    virtual qint64 messagesGetDocumentByHash(const QByteArray &sha256, qint32 size, const QString &mime_type, qint32 timeout = timeOut());
    virtual qint64 messagesSearchGifs(const QString &q, qint32 offset, qint32 timeout = timeOut());
    virtual qint64 messagesGetSavedGifs(qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesSaveGif(const InputDocument &id, bool unsave, qint32 timeout = timeOut());
    virtual qint64 messagesGetInlineBotResults(const InputUser &bot, const InputPeer &peer, const InputGeoPoint &geo_point, const QString &query, const QString &offset, qint32 timeout = timeOut());
    virtual qint64 messagesSetInlineBotResults(bool gallery, bool privateValue, qint64 query_id, const QList<InputBotInlineResult> &results, qint32 cache_time, const QString &next_offset, const InlineBotSwitchPM &switch_pm, qint32 timeout = timeOut());
    virtual qint64 messagesSendInlineBotResult(bool silent, bool background, bool clear_draft, const InputPeer &peer, qint32 reply_to_msg_id, qint64 random_id, qint64 query_id, const QString &id, qint32 timeout = timeOut());
    virtual qint64 messagesGetMessageEditData(const InputPeer &peer, qint32 id, qint32 timeout = timeOut());
    virtual qint64 messagesEditMessage(bool no_webpage, const InputPeer &peer, qint32 id, const QString &message, const ReplyMarkup &reply_markup, const QList<MessageEntity> &entities, qint32 timeout = timeOut());
    virtual qint64 messagesEditInlineBotMessage(bool no_webpage, const InputBotInlineMessageID &id, const QString &message, const ReplyMarkup &reply_markup, const QList<MessageEntity> &entities, qint32 timeout = timeOut());
    virtual qint64 messagesGetBotCallbackAnswer(bool game, const InputPeer &peer, qint32 msg_id, const QByteArray &data, qint32 timeout = timeOut());
    virtual qint64 messagesSetBotCallbackAnswer(bool alert, qint64 query_id, const QString &message, const QString &url, qint32 cache_time, qint32 timeout = timeOut());
    virtual qint64 messagesGetPeerDialogs(const QList<InputPeer> &peers, qint32 timeout = timeOut());
    virtual qint64 messagesSaveDraft(bool no_webpage, qint32 reply_to_msg_id, const InputPeer &peer, const QString &message, const QList<MessageEntity> &entities, qint32 timeout = timeOut());
    virtual qint64 messagesGetAllDrafts(qint32 timeout = timeOut());
    virtual qint64 messagesGetFeaturedStickers(qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesReadFeaturedStickers(const QList<qint64> &id, qint32 timeout = timeOut());
    virtual qint64 messagesGetRecentStickers(bool attached, qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesSaveRecentSticker(bool attached, const InputDocument &id, bool unsave, qint32 timeout = timeOut());
    virtual qint64 messagesClearRecentStickers(bool attached, qint32 timeout = timeOut());
    virtual qint64 messagesGetArchivedStickers(bool masks, qint64 offset_id, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 messagesGetMaskStickers(qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesGetAttachedStickers(const InputStickeredMedia &media, qint32 timeout = timeOut());
    virtual qint64 messagesSetGameScore(bool edit_message, bool force, const InputPeer &peer, qint32 id, const InputUser &user_id, qint32 score, qint32 timeout = timeOut());
    virtual qint64 messagesSetInlineGameScore(bool edit_message, bool force, const InputBotInlineMessageID &id, const InputUser &user_id, qint32 score, qint32 timeout = timeOut());
    virtual qint64 messagesGetGameHighScores(const InputPeer &peer, qint32 id, const InputUser &user_id, qint32 timeout = timeOut());
    virtual qint64 messagesGetInlineGameHighScores(const InputBotInlineMessageID &id, const InputUser &user_id, qint32 timeout = timeOut());
    virtual qint64 messagesGetCommonChats(const InputUser &user_id, qint32 max_id, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 messagesGetAllChats(const QList<qint32> &except_ids, qint32 timeout = timeOut());
    virtual qint64 messagesGetWebPage(const QString &url, qint32 hash, qint32 timeout = timeOut());
    virtual qint64 messagesToggleDialogPin(bool pinned, const InputPeer &peer, qint32 timeout = timeOut());
    virtual qint64 messagesReorderPinnedDialogs(bool force, const QList<InputPeer> &order, qint32 timeout = timeOut());
    virtual qint64 messagesGetPinnedDialogs(qint32 timeout = timeOut());
    virtual qint64 messagesSetBotShippingResults(qint64 query_id, const QString &error, const QList<ShippingOption> &shipping_options, qint32 timeout = timeOut());
    virtual qint64 messagesSetBotPrecheckoutResults(bool success, qint64 query_id, const QString &error, qint32 timeout = timeOut());
    virtual qint64 messagesUploadMedia(const InputPeer &peer, const InputMedia &media, qint32 timeout = timeOut());

    virtual qint64 paymentsGetPaymentForm(qint32 msg_id, qint32 timeout = timeOut());
    virtual qint64 paymentsGetPaymentReceipt(qint32 msg_id, qint32 timeout = timeOut());
    virtual qint64 paymentsValidateRequestedInfo(bool save, qint32 msg_id, const PaymentRequestedInfo &info, qint32 timeout = timeOut());
    virtual qint64 paymentsSendPaymentForm(qint32 msg_id, const QString &requested_info_id, const QString &shipping_option_id, const InputPaymentCredentials &credentials, qint32 timeout = timeOut());
    virtual qint64 paymentsGetSavedInfo(qint32 timeout = timeOut());
    virtual qint64 paymentsClearSavedInfo(bool credentials, bool info, qint32 timeout = timeOut());

    virtual qint64 phoneGetCallConfig(qint32 timeout = timeOut());
    virtual qint64 phoneRequestCall(const InputUser &user_id, qint32 random_id, const QByteArray &g_a_hash, const PhoneCallProtocol &protocol, qint32 timeout = timeOut());
    virtual qint64 phoneAcceptCall(const InputPhoneCall &peer, const QByteArray &g_b, const PhoneCallProtocol &protocol, qint32 timeout = timeOut());
    virtual qint64 phoneConfirmCall(const InputPhoneCall &peer, const QByteArray &g_a, qint64 key_fingerprint, const PhoneCallProtocol &protocol, qint32 timeout = timeOut());
    virtual qint64 phoneReceivedCall(const InputPhoneCall &peer, qint32 timeout = timeOut());
    virtual qint64 phoneDiscardCall(const InputPhoneCall &peer, qint32 duration, const PhoneCallDiscardReason &reason, qint64 connection_id, qint32 timeout = timeOut());
    virtual qint64 phoneSetCallRating(const InputPhoneCall &peer, qint32 rating, const QString &comment, qint32 timeout = timeOut());
    virtual qint64 phoneSaveCallDebug(const InputPhoneCall &peer, const DataJSON &debug, qint32 timeout = timeOut());

    virtual qint64 photosUpdateProfilePhoto(const InputPhoto &id, qint32 timeout = timeOut());
    virtual qint64 photosUploadProfilePhoto(const InputFile &file, qint32 timeout = timeOut());
    virtual qint64 photosDeletePhotos(const QList<InputPhoto> &id, qint32 timeout = timeOut());
    virtual qint64 photosGetUserPhotos(const InputUser &user_id, qint32 offset, qint64 max_id, qint32 limit, qint32 timeout = timeOut());

    virtual qint64 stickersCreateStickerSet(bool masks, const InputUser &user_id, const QString &title, const QString &short_name, const QList<InputStickerSetItem> &stickers, qint32 timeout = timeOut());
    virtual qint64 stickersRemoveStickerFromSet(const InputDocument &sticker, qint32 timeout = timeOut());
    virtual qint64 stickersChangeStickerPosition(const InputDocument &sticker, qint32 position, qint32 timeout = timeOut());
    virtual qint64 stickersAddStickerToSet(const InputStickerSet &stickerset, const InputStickerSetItem &sticker, qint32 timeout = timeOut());

    virtual qint64 updatesGetState(qint32 timeout = timeOut());
    virtual qint64 updatesGetDifference(qint32 pts, qint32 pts_total_limit, qint32 date, qint32 qts, qint32 timeout = timeOut());
    virtual qint64 updatesGetChannelDifference(bool force, const InputChannel &channel, const ChannelMessagesFilter &filter, qint32 pts, qint32 limit, qint32 timeout = timeOut());

    virtual qint64 uploadSaveFilePart(qint64 file_id, qint32 file_part, const QByteArray &bytes, qint32 timeout = timeOut());
    virtual qint64 uploadGetFile(const InputFileLocation &location, qint32 offset, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 uploadSaveBigFilePart(qint64 file_id, qint32 file_part, qint32 file_total_parts, const QByteArray &bytes, qint32 timeout = timeOut());
    virtual qint64 uploadGetWebFile(const InputWebFileLocation &location, qint32 offset, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 uploadGetCdnFile(const QByteArray &file_token, qint32 offset, qint32 limit, qint32 timeout = timeOut());
    virtual qint64 uploadReuploadCdnFile(const QByteArray &file_token, const QByteArray &request_token, qint32 timeout = timeOut());

    virtual qint64 usersGetUsers(const QList<InputUser> &id, qint32 timeout = timeOut());
    virtual qint64 usersGetFullUser(const InputUser &id, qint32 timeout = timeOut());
