...
public:
    ...
    EncryptedChat(const EncryptedChat &another);
    ...
    static EncryptedChat fromJson(const QString &json);

    bool operator ==(const EncryptedChat &b) const;
    EncryptedChat &operator =(const EncryptedChat &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const EncryptedChat &item);
