...
ChannelsChannelParticipants::ChannelsChannelParticipants(const ChannelsChannelParticipants &another) :
    TelegramTypeObject(),
    m_count(0),
    m_classType(typeChannelsChannelParticipants)
{
...
ChannelsChannelParticipants &ChannelsChannelParticipants::operator =(const ChannelsChannelParticipants &b) {
...
ChannelsChannelParticipants ChannelsChannelParticipants::fromJson(const QString &json) {
    return ChannelsChannelParticipants::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const ChannelsChannelParticipants &item) {
    ...
    switch(item.classType()) {
    case ChannelsChannelParticipants::typeChannelsChannelParticipants:
        debug.nospace() << "classType: typeChannelsChannelParticipants";
