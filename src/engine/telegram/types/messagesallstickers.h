...
public:
    ...
    MessagesAllStickers(const MessagesAllStickers &another);
    ...
    static MessagesAllStickers fromJson(const QString &json);

    bool operator ==(const MessagesAllStickers &b) const;
    MessagesAllStickers &operator =(const MessagesAllStickers &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const MessagesAllStickers &item);
