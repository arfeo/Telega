...
MessagesFoundGifs::MessagesFoundGifs(const MessagesFoundGifs &another) :
    TelegramTypeObject(),
    m_nextOffset(0),
    m_classType(typeMessagesFoundGifs)
{
...
MessagesFoundGifs &MessagesFoundGifs::operator =(const MessagesFoundGifs &b) {
...
MessagesFoundGifs MessagesFoundGifs::fromJson(const QString &json) {
    return MessagesFoundGifs::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const MessagesFoundGifs &item) {
    ...
    switch(item.classType()) {
    case MessagesFoundGifs::typeMessagesFoundGifs:
        debug.nospace() << "classType: typeMessagesFoundGifs";
