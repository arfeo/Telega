...
InputEncryptedFile::InputEncryptedFile(const InputEncryptedFile &another) :
    TelegramTypeObject(),
    m_accessHash(0),
    m_id(0),
    m_keyFingerprint(0),
...
InputEncryptedFile &InputEncryptedFile::operator =(const InputEncryptedFile &b) {
...
QMap<QString, QVariant> InputEncryptedFile::toMap() const {
...
InputEncryptedFile InputEncryptedFile::fromMap(const QMap<QString, QVariant> &map) {
...
InputEncryptedFile InputEncryptedFile::fromJson(const QString &json) {
    return InputEncryptedFile::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
QDebug operator<<(QDebug debug,  const InputEncryptedFile &item) {
    ...
    switch(item.classType()) {
    case InputEncryptedFile::typeInputEncryptedFileEmpty:
        debug.nospace() << "classType: typeInputEncryptedFileEmpty";
        break;
    case InputEncryptedFile::typeInputEncryptedFileUploaded:
        debug.nospace() << "classType: typeInputEncryptedFileUploaded";
        ...
        break;
    case InputEncryptedFile::typeInputEncryptedFile:
        debug.nospace() << "classType: typeInputEncryptedFile";
        debug.nospace() << ", id: " << item.id();
        debug.nospace() << ", accessHash: " << item.accessHash();
        break;
    case InputEncryptedFile::typeInputEncryptedFileBigUploaded:
        debug.nospace() << "classType: typeInputEncryptedFileBigUploaded";
        debug.nospace() << ", id: " << item.id();
        debug.nospace() << ", parts: " << item.parts();
        debug.nospace() << ", keyFingerprint: " << item.keyFingerprint();
        break;
