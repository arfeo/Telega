...
public:
    ...
    PhotosPhotos(const PhotosPhotos &another);
    ...
    static PhotosPhotos fromJson(const QString &json);

    bool operator ==(const PhotosPhotos &b) const;
    PhotosPhotos &operator =(const PhotosPhotos &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const PhotosPhotos &item);
