...
public:
    ...
    ContactsImportedContacts(const ContactsImportedContacts &another);
    ...
    static ContactsImportedContacts fromJson(const QString &json);

    bool operator ==(const ContactsImportedContacts &b) const;
    ContactsImportedContacts &operator =(const ContactsImportedContacts &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ContactsImportedContacts &item);
