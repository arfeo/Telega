...
public:
    ...
    InputPeerNotifySettings(const InputPeerNotifySettings &another);
    ...
    static InputPeerNotifySettings fromJson(const QString &json);

    bool operator ==(const InputPeerNotifySettings &b) const;
    InputPeerNotifySettings &operator =(const InputPeerNotifySettings &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const InputPeerNotifySettings &item);
