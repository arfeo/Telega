...
public:
    ...
    InputDocument(const InputDocument &another);
    ...
    static InputDocument fromJson(const QString &json);

    bool operator ==(const InputDocument &b) const;
    InputDocument &operator =(const InputDocument &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const InputDocument &item);
