...
public:
    ...
    MessagesChatFull(const MessagesChatFull &another);
    ...
    static MessagesChatFull fromJson(const QString &json);

    bool operator ==(const MessagesChatFull &b) const;
    MessagesChatFull &operator =(const MessagesChatFull &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const MessagesChatFull &item);
