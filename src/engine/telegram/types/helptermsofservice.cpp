...
HelpTermsOfService::HelpTermsOfService(const HelpTermsOfService &another) :
    TelegramTypeObject(),
    m_classType(typeHelpTermsOfService)
{
    operator=(another);
...
HelpTermsOfService &HelpTermsOfService::operator =(const HelpTermsOfService &b) {
...
HelpTermsOfService HelpTermsOfService::fromJson(const QString &json) {
    return HelpTermsOfService::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
QDebug operator<<(QDebug debug,  const HelpTermsOfService &item) {
    ...
    switch(item.classType()) {
    case HelpTermsOfService::typeHelpTermsOfService:
        debug.nospace() << "classType: typeHelpTermsOfService";
