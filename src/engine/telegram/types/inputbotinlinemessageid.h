...
public:
    ...
    InputBotInlineMessageID(const InputBotInlineMessageID &another);
    ...
    static InputBotInlineMessageID fromJson(const QString &json);

    bool operator ==(const InputBotInlineMessageID &b) const;
    InputBotInlineMessageID &operator =(const InputBotInlineMessageID &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const InputBotInlineMessageID &item);
