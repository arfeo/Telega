...
public:
    ...
    MessagesDialogs(const MessagesDialogs &another);
    ...
    static MessagesDialogs fromJson(const QString &json);

    bool operator ==(const MessagesDialogs &b) const;
    MessagesDialogs &operator =(const MessagesDialogs &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const MessagesDialogs &item);
