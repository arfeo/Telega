...
MessagesStickers::MessagesStickers(const MessagesStickers &another) :
    TelegramTypeObject(),
    m_classType(typeMessagesStickersNotModified)
{
    operator=(another);
...
MessagesStickers &MessagesStickers::operator =(const MessagesStickers &b) {
...
MessagesStickers MessagesStickers::fromJson(const QString &json) {
    return MessagesStickers::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
QDebug operator<<(QDebug debug,  const MessagesStickers &item) {
    ...
    switch(item.classType()) {
    case MessagesStickers::typeMessagesStickersNotModified:
        debug.nospace() << "classType: typeMessagesStickersNotModified";
        break;
    case MessagesStickers::typeMessagesStickers:
        debug.nospace() << "classType: typeMessagesStickers";
