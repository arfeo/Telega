...
public:
    ...
    static UserFull fromJson(const QString &json);

    bool operator ==(const UserFull &b) const;
    UserFull &operator =(const UserFull &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const UserFull &item);
