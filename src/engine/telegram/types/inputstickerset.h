...
public:
    ...
    InputStickerSet(const InputStickerSet &another);
    ...
    static InputStickerSet fromJson(const QString &json);

    bool operator ==(const InputStickerSet &b) const;
    InputStickerSet &operator =(const InputStickerSet &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const InputStickerSet &item);
