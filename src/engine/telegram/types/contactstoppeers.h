...
public:
    ...
    ContactsTopPeers(const ContactsTopPeers &another);
    ...
    static ContactsTopPeers fromJson(const QString &json);

    bool operator ==(const ContactsTopPeers &b) const;
    ContactsTopPeers &operator =(const ContactsTopPeers &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ContactsTopPeers &item);
