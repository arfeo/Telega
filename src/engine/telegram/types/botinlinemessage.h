...
public:
    ...
    BotInlineMessage(const BotInlineMessage &another);
    ...
    static BotInlineMessage fromJson(const QString &json);

    bool operator ==(const BotInlineMessage &b) const;
    BotInlineMessage &operator =(const BotInlineMessage &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const BotInlineMessage &item);
