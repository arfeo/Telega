...
public:
    ...
    ReplyMarkup(const ReplyMarkup &another);
    virtual ~ReplyMarkup();
    ...
    static ReplyMarkup fromJson(const QString &json);

    bool operator ==(const ReplyMarkup &b) const;
    ReplyMarkup &operator =(const ReplyMarkup &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ReplyMarkup &item);
