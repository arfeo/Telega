...
MessagesSavedGifs::MessagesSavedGifs(const MessagesSavedGifs &another) :
    TelegramTypeObject(),
    m_hash(0),
    m_classType(typeMessagesSavedGifsNotModified)
{
...
MessagesSavedGifs &MessagesSavedGifs::operator =(const MessagesSavedGifs &b) {
...
MessagesSavedGifs MessagesSavedGifs::fromJson(const QString &json) {
    return MessagesSavedGifs::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const MessagesSavedGifs &item) {
    ...
    switch(item.classType()) {
    case MessagesSavedGifs::typeMessagesSavedGifsNotModified:
        debug.nospace() << "classType: typeMessagesSavedGifsNotModified";
        break;
    case MessagesSavedGifs::typeMessagesSavedGifs:
        debug.nospace() << "classType: typeMessagesSavedGifs";
        debug.nospace() << ", hash: " << item.hash();
        debug.nospace() << ", gifs: " << item.gifs();
        break;
    }
    debug.nospace() << ")";
    return debug;
