...
public:
    ...
    MessagesStickers(const MessagesStickers &another);
    ...
    static MessagesStickers fromJson(const QString &json);

    bool operator ==(const MessagesStickers &b) const;
    MessagesStickers &operator =(const MessagesStickers &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const MessagesStickers &item);
