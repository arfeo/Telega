...
MessagesDialogs::MessagesDialogs(const MessagesDialogs &another) :
    TelegramTypeObject(),
    m_count(0),
    m_classType(typeMessagesDialogs)
{
...
MessagesDialogs &MessagesDialogs::operator =(const MessagesDialogs &b) {
...
QMap<QString, QVariant> MessagesDialogs::toMap() const {
...
MessagesDialogs MessagesDialogs::fromMap(const QMap<QString, QVariant> &map) {
...
MessagesDialogs MessagesDialogs::fromJson(const QString &json) {
    return MessagesDialogs::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}

QByteArray MessagesDialogs::getHash(QCryptographicHash::Algorithm alg) const {
    QByteArray data;
...
/*QDebug operator<<(QDebug debug,  const MessagesDialogs &item) {
    ...
    switch(item.classType()) {
    case MessagesDialogs::typeMessagesDialogs:
        debug.nospace() << "classType: typeMessagesDialogs";
        ...
        break;
    case MessagesDialogs::typeMessagesDialogsSlice:
        debug.nospace() << "classType: typeMessagesDialogsSlice";
