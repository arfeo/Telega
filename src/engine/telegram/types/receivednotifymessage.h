...
public:
    ...
    ReceivedNotifyMessage(const ReceivedNotifyMessage &another);
    ...
    static ReceivedNotifyMessage fromJson(const QString &json);

    bool operator ==(const ReceivedNotifyMessage &b) const;
    ReceivedNotifyMessage &operator =(const ReceivedNotifyMessage &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ReceivedNotifyMessage &item);
