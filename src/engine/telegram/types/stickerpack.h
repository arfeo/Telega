...
public:
    ...
    StickerPack(const StickerPack &another);
    virtual ~StickerPack();
    ...
    static StickerPack fromJson(const QString &json);

    bool operator ==(const StickerPack &b) const;
    StickerPack &operator =(const StickerPack &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const StickerPack &item);
