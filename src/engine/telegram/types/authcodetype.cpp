...
AuthCodeType::AuthCodeType(const AuthCodeType &another) :
    TelegramTypeObject(),
    m_classType(typeAuthCodeTypeSms)
{
    operator=(another);
...
AuthCodeType &AuthCodeType::operator =(const AuthCodeType &b) {
...
AuthCodeType AuthCodeType::fromJson(const QString &json) {
    return AuthCodeType::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const AuthCodeType &item) {
    ...
    switch(item.classType()) {
    case AuthCodeType::typeAuthCodeTypeSms:
        debug.nospace() << "classType: typeAuthCodeTypeSms";
        break;
    case AuthCodeType::typeAuthCodeTypeCall:
        debug.nospace() << "classType: typeAuthCodeTypeCall";
        break;
    case AuthCodeType::typeAuthCodeTypeFlashCall:
        debug.nospace() << "classType: typeAuthCodeTypeFlashCall";
        break;
    }
    debug.nospace() << ")";
    return debug;
