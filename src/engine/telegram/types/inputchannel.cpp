...
InputChannel::InputChannel(const InputChannel &another) :
    TelegramTypeObject(),
    m_accessHash(0),
    m_channelId(0),
    m_classType(typeInputChannelEmpty)
...
InputChannel &InputChannel::operator =(const InputChannel &b) {
...
InputChannel InputChannel::fromJson(const QString &json) {
    return InputChannel::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const InputChannel &item) {
    ...
    switch(item.classType()) {
    case InputChannel::typeInputChannelEmpty:
        debug.nospace() << "classType: typeInputChannelEmpty";
        break;
    case InputChannel::typeInputChannel:
        debug.nospace() << "classType: typeInputChannel";
