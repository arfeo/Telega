...
public:
    ...
    BotInlineResult(const BotInlineResult &another);
    ...
    static BotInlineResult fromJson(const QString &json);

    bool operator ==(const BotInlineResult &b) const;
    BotInlineResult &operator =(const BotInlineResult &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const BotInlineResult &item);
