...
public:
    enum UpdatesDifferenceClassType {
        ...
        typeUpdatesDifferenceTooLong = 0x4afe8f6d
    };
    ...
    UpdatesDifference(const UpdatesDifference &another);
    ...
    static UpdatesDifference fromJson(const QString &json);

    bool operator ==(const UpdatesDifference &b) const;
    UpdatesDifference &operator =(const UpdatesDifference &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const UpdatesDifference &item);
