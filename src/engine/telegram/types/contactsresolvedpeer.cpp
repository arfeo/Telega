...
ContactsResolvedPeer::ContactsResolvedPeer(const ContactsResolvedPeer &another) :
    TelegramTypeObject(),
    m_classType(typeContactsResolvedPeer)
{
    operator=(another);
...
ContactsResolvedPeer &ContactsResolvedPeer::operator =(const ContactsResolvedPeer &b) {
...
ContactsResolvedPeer ContactsResolvedPeer::fromJson(const QString &json) {
    return ContactsResolvedPeer::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const ContactsResolvedPeer &item) {
    ...
    switch(item.classType()) {
    case ContactsResolvedPeer::typeContactsResolvedPeer:
        debug.nospace() << "classType: typeContactsResolvedPeer";
