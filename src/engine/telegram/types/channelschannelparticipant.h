...
public:
    ...
    ChannelsChannelParticipant(const ChannelsChannelParticipant &another);
    ...
    static ChannelsChannelParticipant fromJson(const QString &json);

    bool operator ==(const ChannelsChannelParticipant &b) const;
    ChannelsChannelParticipant &operator =(const ChannelsChannelParticipant &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ChannelsChannelParticipant &item);
