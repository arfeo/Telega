...
InputNotifyPeer::InputNotifyPeer(const InputNotifyPeer &another) :
    TelegramTypeObject(),
    m_classType(typeInputNotifyPeer)
{
    operator=(another);
...
InputNotifyPeer &InputNotifyPeer::operator =(const InputNotifyPeer &b) {
...
InputNotifyPeer InputNotifyPeer::fromJson(const QString &json) {
    return InputNotifyPeer::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
/*QDebug operator<<(QDebug debug,  const InputNotifyPeer &item) {
    ...
    switch(item.classType()) {
    case InputNotifyPeer::typeInputNotifyPeer:
        debug.nospace() << "classType: typeInputNotifyPeer";
        debug.nospace() << ", peer: " << item.peer();
        break;
    case InputNotifyPeer::typeInputNotifyUsers:
        debug.nospace() << "classType: typeInputNotifyUsers";
        break;
    case InputNotifyPeer::typeInputNotifyChats:
        debug.nospace() << "classType: typeInputNotifyChats";
        break;
    case InputNotifyPeer::typeInputNotifyAll:
        debug.nospace() << "classType: typeInputNotifyAll";
        break;
    }
    debug.nospace() << ")";
    return debug;
