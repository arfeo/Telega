...
public:
    ...
    AccountPasswordSettings(const AccountPasswordSettings &another);
    ...
    static AccountPasswordSettings fromJson(const QString &json);

    bool operator ==(const AccountPasswordSettings &b) const;
    AccountPasswordSettings &operator =(const AccountPasswordSettings &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const AccountPasswordSettings &item);
