...
public:
    ...
    DisabledFeature(const DisabledFeature &another);
    ...
    static DisabledFeature fromJson(const QString &json);

    bool operator ==(const DisabledFeature &b) const;
    DisabledFeature &operator =(const DisabledFeature &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const DisabledFeature &item);
