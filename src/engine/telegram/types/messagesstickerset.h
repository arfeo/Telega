...
public:
    ...
    MessagesStickerSet(const MessagesStickerSet &another);
    ...
    static MessagesStickerSet fromJson(const QString &json);

    bool operator ==(const MessagesStickerSet &b) const;
    MessagesStickerSet &operator =(const MessagesStickerSet &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const MessagesStickerSet &item);
