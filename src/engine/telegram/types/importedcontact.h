...
public:
    ...
    ImportedContact(const ImportedContact &another);
    ...
    static ImportedContact fromJson(const QString &json);

    bool operator ==(const ImportedContact &b) const;
    ImportedContact &operator =(const ImportedContact &b);
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const ImportedContact &item);
