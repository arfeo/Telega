...
public:
    ...
    Authorization(AuthorizationClassType classType = typeAuthorization, InboundPkt *in = 0);
    Authorization(InboundPkt *in);
    Authorization(const Null&);
    Authorization(const Authorization &another);
    ...
    void setClassType(AuthorizationClassType classType);
    AuthorizationClassType classType() const;

    bool fetch(InboundPkt *in);
    bool push(OutboundPkt *out) const;

    QMap<QString, QVariant> toMap() const;
    static Authorization fromMap(const QMap<QString, QVariant> &map);
    static Authorization fromJson(const QString &json);

    bool operator ==(const Authorization &b) const;
    Authorization &operator =(const Authorization &b);
...
private:
    ...
    AuthorizationClassType m_classType;
};
...
QDebug LIBQTELEGRAMSHARED_EXPORT operator<<(QDebug debug,  const Authorization &item);
