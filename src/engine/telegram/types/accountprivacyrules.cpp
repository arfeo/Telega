...
AccountPrivacyRules::AccountPrivacyRules(const AccountPrivacyRules &another) :
    TelegramTypeObject(),
    m_classType(typeAccountPrivacyRules)
{
    operator=(another);
...
AccountPrivacyRules &AccountPrivacyRules::operator =(const AccountPrivacyRules &b) {
...
AccountPrivacyRules AccountPrivacyRules::fromJson(const QString &json) {
    return AccountPrivacyRules::fromMap(QJsonDocument::fromJson(json.toUtf8()).toVariant().toMap());
}
...
QDebug operator<<(QDebug debug,  const AccountPrivacyRules &item) {
    ...
    Q_UNUSED(saver)
    debug.nospace() << "Telegram.AccountPrivacyRules(";
    switch(item.classType()) {
    case AccountPrivacyRules::typeAccountPrivacyRules:
        debug.nospace() << "classType: typeAccountPrivacyRules";
