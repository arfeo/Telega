...
void MessagesFilterObject::setFlags(qint32 flags) {
...
qint32 MessagesFilterObject::flags() const {
    return m_core.flags();
}

void MessagesFilterObject::setMissed(bool missed) {
    if(m_core.missed() == missed) return;
    m_core.setMissed(missed);
    Q_EMIT missedChanged();
    Q_EMIT coreChanged();
}

bool MessagesFilterObject::missed() const {
    return m_core.missed();
}
...
void MessagesFilterObject::setClassType(quint32 classType) {
    ...
    case TypeInputMessagesFilterPhoneCalls:
        result = MessagesFilter::typeInputMessagesFilterPhoneCalls;
        break;
    case TypeInputMessagesFilterRoundVoice:
        result = MessagesFilter::typeInputMessagesFilterRoundVoice;
        break;
    case TypeInputMessagesFilterRoundVideo:
        result = MessagesFilter::typeInputMessagesFilterRoundVideo;
        break;
    default:
        result = MessagesFilter::typeInputMessagesFilterEmpty;
        break;
...
quint32 MessagesFilterObject::classType() const {
    ...
    case MessagesFilter::typeInputMessagesFilterPhoneCalls:
        result = TypeInputMessagesFilterPhoneCalls;
        break;
    case MessagesFilter::typeInputMessagesFilterRoundVoice:
        result = TypeInputMessagesFilterRoundVoice;
        break;
    case MessagesFilter::typeInputMessagesFilterRoundVideo:
        result = TypeInputMessagesFilterRoundVideo;
        break;
    default:
        result = TypeInputMessagesFilterEmpty;
        break;
