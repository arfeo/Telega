...
class LIBQTELEGRAMSHARED_EXPORT DcOptionObject : public TelegramTypeQObject
{
    ...
    Q_PROPERTY(bool cdn READ cdn WRITE setCdn NOTIFY cdnChanged)
    ...
    Q_PROPERTY(bool staticValue READ staticValue WRITE setStaticValue NOTIFY staticValueChanged)
