...
void MessagesChatsObject::setCount(qint32 count) {
...
qint32 MessagesChatsObject::count() const {
    return m_core.count();
}
...
void MessagesChatsObject::setClassType(quint32 classType) {
    ...
    case TypeMessagesChatsSlice:
        result = MessagesChats::typeMessagesChatsSlice;
        break;
    default:
        result = MessagesChats::typeMessagesChats;
        break;
