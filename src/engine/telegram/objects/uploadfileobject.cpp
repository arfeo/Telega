...
void UploadFileObject::setDcId(qint32 dcId) {
...
qint32 UploadFileObject::dcId() const {
    return m_core.dcId();
}

void UploadFileObject::setEncryptionIv(const QByteArray &encryptionIv) {
    if(m_core.encryptionIv() == encryptionIv) return;
    m_core.setEncryptionIv(encryptionIv);
    Q_EMIT encryptionIvChanged();
    Q_EMIT coreChanged();
}

QByteArray UploadFileObject::encryptionIv() const {
    return m_core.encryptionIv();
}

void UploadFileObject::setEncryptionKey(const QByteArray &encryptionKey) {
    if(m_core.encryptionKey() == encryptionKey) return;
    m_core.setEncryptionKey(encryptionKey);
    Q_EMIT encryptionKeyChanged();
    Q_EMIT coreChanged();
}

QByteArray UploadFileObject::encryptionKey() const {
    return m_core.encryptionKey();
}

void UploadFileObject::setFileToken(const QByteArray &fileToken) {
    if(m_core.fileToken() == fileToken) return;
    m_core.setFileToken(fileToken);
    Q_EMIT fileTokenChanged();
    Q_EMIT coreChanged();
}

QByteArray UploadFileObject::fileToken() const {
    return m_core.fileToken();
}
...
void UploadFileObject::setClassType(quint32 classType) {
    ...
    case TypeUploadFileCdnRedirect:
        result = UploadFile::typeUploadFileCdnRedirect;
        break;
    default:
        result = UploadFile::typeUploadFile;
        break;
...
quint32 UploadFileObject::classType() const {
    ...
    case UploadFile::typeUploadFileCdnRedirect:
        result = TypeUploadFileCdnRedirect;
        break;
    default:
        result = TypeUploadFile;
        break;
