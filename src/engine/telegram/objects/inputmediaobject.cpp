...
void InputMediaObject::setDescription(const QString &description) {
...
QString InputMediaObject::description() const {
...
void InputMediaObject::setFlags(qint32 flags) {
...
qint32 InputMediaObject::flags() const {
    return m_core.flags();
}
...
void InputMediaObject::setIdInputGame(InputGameObject* idInputGame) {
    if(m_idInputGame == idInputGame) return;
    if(m_idInputGame) delete m_idInputGame;
...
InputGameObject*  InputMediaObject::idInputGame() const {
...
void InputMediaObject::setInvoice(InvoiceObject* invoice) {
...
InvoiceObject*  InputMediaObject::invoice() const {
    return m_invoice;
}
...
void InputMediaObject::setPayload(const QByteArray &payload) {
...
QByteArray InputMediaObject::payload() const {
...
void InputMediaObject::setPhoto(InputWebDocumentObject* photo) {
...
InputWebDocumentObject*  InputMediaObject::photo() const {
    return m_photo;
}
...
void InputMediaObject::setStartParam(const QString &startParam) {
...
QString InputMediaObject::startParam() const {
    return m_core.startParam();
}

void InputMediaObject::setStickers(const QList<InputDocument> &stickers) {
...
QList<InputDocument> InputMediaObject::stickers() const {
...
InputMediaObject &InputMediaObject::operator =(const InputMedia &b) {
    ...
    m_idInputGame->setCore(b.idInputGame());
...
void InputMediaObject::setClassType(quint32 classType) {
    ...
    case TypeInputMediaPhotoExternal:
        result = InputMedia::typeInputMediaPhotoExternal;
        break;
    case TypeInputMediaDocumentExternal:
        result = InputMedia::typeInputMediaDocumentExternal;
        break;
    case TypeInputMediaGame:
        result = InputMedia::typeInputMediaGame;
        break;
    case TypeInputMediaInvoice:
        result = InputMedia::typeInputMediaInvoice;
        break;
    default:
        result = InputMedia::typeInputMediaEmpty;
        break;
...
quint32 InputMediaObject::classType() const {
    ...
    case InputMedia::typeInputMediaPhotoExternal:
        result = TypeInputMediaPhotoExternal;
        break;
    case InputMedia::typeInputMediaDocumentExternal:
        result = TypeInputMediaDocumentExternal;
        break;
    case InputMedia::typeInputMediaGame:
        result = TypeInputMediaGame;
        break;
    case InputMedia::typeInputMediaInvoice:
        result = TypeInputMediaInvoice;
        break;
    default:
        result = TypeInputMediaEmpty;
        break;
...
void InputMediaObject::coreIdInputGameChanged() {
    if(m_core.idInputGame() == m_idInputGame->core()) return;
    m_core.setIdInputGame(m_idInputGame->core());
    Q_EMIT idInputGameChanged();
    Q_EMIT coreChanged();
}
...
void InputMediaObject::coreInvoiceChanged() {
...
void InputMediaObject::corePhotoChanged() {
