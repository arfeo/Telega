...
void UserFullObject::setCommonChatsCount(qint32 commonChatsCount) {
    if(m_core.commonChatsCount() == commonChatsCount) return;
    m_core.setCommonChatsCount(commonChatsCount);
    Q_EMIT commonChatsCountChanged();
    Q_EMIT coreChanged();
}

qint32 UserFullObject::commonChatsCount() const {
    return m_core.commonChatsCount();
}
...
void UserFullObject::setPhoneCallsAvailable(bool phoneCallsAvailable) {
    if(m_core.phoneCallsAvailable() == phoneCallsAvailable) return;
    m_core.setPhoneCallsAvailable(phoneCallsAvailable);
    Q_EMIT phoneCallsAvailableChanged();
    Q_EMIT coreChanged();
}

bool UserFullObject::phoneCallsAvailable() const {
    return m_core.phoneCallsAvailable();
}

void UserFullObject::setPhoneCallsPrivate(bool phoneCallsPrivate) {
    if(m_core.phoneCallsPrivate() == phoneCallsPrivate) return;
    m_core.setPhoneCallsPrivate(phoneCallsPrivate);
    Q_EMIT phoneCallsPrivateChanged();
    Q_EMIT coreChanged();
}

bool UserFullObject::phoneCallsPrivate() const {
    return m_core.phoneCallsPrivate();
}
