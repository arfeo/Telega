...
void ChatFullObject::setBannedCount(qint32 bannedCount) {
    if(m_core.bannedCount() == bannedCount) return;
    m_core.setBannedCount(bannedCount);
    Q_EMIT bannedCountChanged();
    Q_EMIT coreChanged();
}

qint32 ChatFullObject::bannedCount() const {
    return m_core.bannedCount();
}
...
void ChatFullObject::setReadOutboxMaxId(qint32 readOutboxMaxId) {
...
qint32 ChatFullObject::readOutboxMaxId() const {
