...
void qtelegramRegisterQmlTypes(const char *uri, int major, int minor) {
    ...
    qmlRegisterType<CdnConfigObject>(uri, major, minor, "CdnConfig");
    qmlRegisterType<CdnPublicKeyObject>(uri, major, minor, "CdnPublicKey");
    qmlRegisterType<ChannelAdminLogEventObject>(uri, major, minor, "ChannelAdminLogEvent");
    qmlRegisterType<ChannelAdminLogEventActionObject>(uri, major, minor, "ChannelAdminLogEventAction");
    qmlRegisterType<ChannelAdminLogEventsFilterObject>(uri, major, minor, "ChannelAdminLogEventsFilter");
    qmlRegisterType<ChannelAdminRightsObject>(uri, major, minor, "ChannelAdminRights");
    qmlRegisterType<ChannelBannedRightsObject>(uri, major, minor, "ChannelBannedRights");
    ...
    qmlRegisterType<DataJSONObject>(uri, major, minor, "DataJSON");
    ...
    qmlRegisterType<GameObject>(uri, major, minor, "Game");
    qmlRegisterType<GeoPointObject>(uri, major, minor, "GeoPoint");
    qmlRegisterType<HighScoreObject>(uri, major, minor, "HighScore");
    ...
    qmlRegisterType<InputGameObject>(uri, major, minor, "InputGame");
    ...
    qmlRegisterType<InputPaymentCredentialsObject>(uri, major, minor, "InputPaymentCredentials");
    ...
    qmlRegisterType<InputPhoneCallObject>(uri, major, minor, "InputPhoneCall");
    ...
    qmlRegisterType<InputStickerSetItemObject>(uri, major, minor, "InputStickerSetItem");
    qmlRegisterType<InputStickeredMediaObject>(uri, major, minor, "InputStickeredMedia");
    qmlRegisterType<InputUserObject>(uri, major, minor, "InputUser");
    qmlRegisterType<InputWebDocumentObject>(uri, major, minor, "InputWebDocument");
    qmlRegisterType<InputWebFileLocationObject>(uri, major, minor, "InputWebFileLocation");
    qmlRegisterType<InvoiceObject>(uri, major, minor, "Invoice");
    ...
    qmlRegisterType<LabeledPriceObject>(uri, major, minor, "LabeledPrice");
    qmlRegisterType<LangPackDifferenceObject>(uri, major, minor, "LangPackDifference");
    qmlRegisterType<LangPackLanguageObject>(uri, major, minor, "LangPackLanguage");
    qmlRegisterType<LangPackStringObject>(uri, major, minor, "LangPackString");
    qmlRegisterType<MaskCoordsObject>(uri, major, minor, "MaskCoords");
    ...
    qmlRegisterType<PageObject>(uri, major, minor, "Page");
    qmlRegisterType<PageBlockObject>(uri, major, minor, "PageBlock");
    qmlRegisterType<PaymentChargeObject>(uri, major, minor, "PaymentCharge");
    qmlRegisterType<PaymentRequestedInfoObject>(uri, major, minor, "PaymentRequestedInfo");
    qmlRegisterType<PaymentSavedCredentialsObject>(uri, major, minor, "PaymentSavedCredentials");
    ...
    qmlRegisterType<PhoneCallObject>(uri, major, minor, "PhoneCall");
    qmlRegisterType<PhoneCallDiscardReasonObject>(uri, major, minor, "PhoneCallDiscardReason");
    qmlRegisterType<PhoneCallProtocolObject>(uri, major, minor, "PhoneCallProtocol");
    qmlRegisterType<PhoneConnectionObject>(uri, major, minor, "PhoneConnection");
    qmlRegisterType<PhotoObject>(uri, major, minor, "Photo");
    qmlRegisterType<PhotoSizeObject>(uri, major, minor, "PhotoSize");
    qmlRegisterType<PostAddressObject>(uri, major, minor, "PostAddress");
    ...
    qmlRegisterType<RichTextObject>(uri, major, minor, "RichText");
    ...
    qmlRegisterType<ShippingOptionObject>(uri, major, minor, "ShippingOption");
    qmlRegisterType<StickerPackObject>(uri, major, minor, "StickerPack");
    qmlRegisterType<StickerSetObject>(uri, major, minor, "StickerSet");
    qmlRegisterType<StickerSetCoveredObject>(uri, major, minor, "StickerSetCovered");
    ...
    qmlRegisterType<WebDocumentObject>(uri, major, minor, "WebDocument");
    ...
    qmlRegisterType<AccountTmpPasswordObject>(uri, major, minor, "AccountTmpPassword");
    ...
    qmlRegisterType<ChannelsAdminLogResultsObject>(uri, major, minor, "ChannelsAdminLogResults");
    ...
    qmlRegisterType<MessagesArchivedStickersObject>(uri, major, minor, "MessagesArchivedStickers");
    ...
    qmlRegisterType<MessagesFeaturedStickersObject>(uri, major, minor, "MessagesFeaturedStickers");
    qmlRegisterType<MessagesFoundGifsObject>(uri, major, minor, "MessagesFoundGifs");
    qmlRegisterType<MessagesHighScoresObject>(uri, major, minor, "MessagesHighScores");
    ...
    qmlRegisterType<MessagesRecentStickersObject>(uri, major, minor, "MessagesRecentStickers");
    ...
    qmlRegisterType<MessagesStickerSetInstallResultObject>(uri, major, minor, "MessagesStickerSetInstallResult");
    qmlRegisterType<MessagesStickersObject>(uri, major, minor, "MessagesStickers");
    qmlRegisterType<PaymentsPaymentFormObject>(uri, major, minor, "PaymentsPaymentForm");
    qmlRegisterType<PaymentsPaymentReceiptObject>(uri, major, minor, "PaymentsPaymentReceipt");
    qmlRegisterType<PaymentsPaymentResultObject>(uri, major, minor, "PaymentsPaymentResult");
    qmlRegisterType<PaymentsSavedInfoObject>(uri, major, minor, "PaymentsSavedInfo");
    qmlRegisterType<PaymentsValidatedRequestedInfoObject>(uri, major, minor, "PaymentsValidatedRequestedInfo");
    qmlRegisterType<PhonePhoneCallObject>(uri, major, minor, "PhonePhoneCall");
    ...
    qmlRegisterType<UploadCdnFileObject>(uri, major, minor, "UploadCdnFile");
    qmlRegisterType<UploadFileObject>(uri, major, minor, "UploadFile");
    qmlRegisterType<UploadWebFileObject>(uri, major, minor, "UploadWebFile");
}
