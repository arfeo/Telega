...
void ChatObject::setAdminRights(ChannelAdminRightsObject* adminRights) {
...
ChannelAdminRightsObject*  ChatObject::adminRights() const {
...
void ChatObject::setBannedRights(ChannelBannedRightsObject* bannedRights) {
...
ChannelBannedRightsObject*  ChatObject::bannedRights() const {
...
void ChatObject::setUntilDate(qint32 untilDate) {
...
qint32 ChatObject::untilDate() const {
...
void ChatObject::coreAdminRightsChanged() {
...
void ChatObject::coreBannedRightsChanged() {
