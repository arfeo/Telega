...
void DcOptionObject::setCdn(bool cdn) {
    if(m_core.cdn() == cdn) return;
    m_core.setCdn(cdn);
    Q_EMIT cdnChanged();
    Q_EMIT coreChanged();
}

bool DcOptionObject::cdn() const {
    return m_core.cdn();
}
...
void DcOptionObject::setStaticValue(bool staticValue) {
    if(m_core.staticValue() == staticValue) return;
    m_core.setStaticValue(staticValue);
    Q_EMIT staticValueChanged();
    Q_EMIT coreChanged();
}

bool DcOptionObject::staticValue() const {
    return m_core.staticValue();
}
