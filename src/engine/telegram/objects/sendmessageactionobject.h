...
public:
    enum SendMessageActionClassType {
        ...
        TypeSendMessageGamePlayAction,
        TypeSendMessageRecordRoundAction,
        TypeSendMessageUploadRoundAction,
        TypeSendMessageTypingActionSecret17,
        TypeSendMessageCancelActionSecret17,
        TypeSendMessageRecordVideoActionSecret17,
        TypeSendMessageUploadVideoActionSecret17,
        TypeSendMessageRecordAudioActionSecret17,
        TypeSendMessageUploadAudioActionSecret17,
        TypeSendMessageUploadPhotoActionSecret17,
        TypeSendMessageUploadDocumentActionSecret17,
        TypeSendMessageGeoLocationActionSecret17,
        TypeSendMessageChooseContactActionSecret17
    };
