...
void PhotoObject::setFlags(qint32 flags) {
...
qint32 PhotoObject::flags() const {
    return m_core.flags();
}

void PhotoObject::setHasStickers(bool hasStickers) {
    if(m_core.hasStickers() == hasStickers) return;
    m_core.setHasStickers(hasStickers);
    Q_EMIT hasStickersChanged();
    Q_EMIT coreChanged();
}

bool PhotoObject::hasStickers() const {
    return m_core.hasStickers();
}
