...
void DocumentAttributeObject::setMask(bool mask) {
    if(m_core.mask() == mask) return;
    m_core.setMask(mask);
    Q_EMIT maskChanged();
    Q_EMIT coreChanged();
}

bool DocumentAttributeObject::mask() const {
    return m_core.mask();
}

void DocumentAttributeObject::setMaskCoords(MaskCoordsObject* maskCoords) {
...
MaskCoordsObject*  DocumentAttributeObject::maskCoords() const {
    return m_maskCoords;
}
...
void DocumentAttributeObject::setRoundMessage(bool roundMessage) {
    if(m_core.roundMessage() == roundMessage) return;
    m_core.setRoundMessage(roundMessage);
    Q_EMIT roundMessageChanged();
    Q_EMIT coreChanged();
}

bool DocumentAttributeObject::roundMessage() const {
    return m_core.roundMessage();
}
...
void DocumentAttributeObject::setClassType(quint32 classType) {
    ...
    case TypeDocumentAttributeHasStickers:
        result = DocumentAttribute::typeDocumentAttributeHasStickers;
        break;
    case TypeDocumentAttributeStickerSecret23:
        result = DocumentAttribute::typeDocumentAttributeStickerSecret23;
        break;
    case TypeDocumentAttributeVideoSecret23:
        result = DocumentAttribute::typeDocumentAttributeVideoSecret23;
        break;
    case TypeDocumentAttributeAudioSecret23:
        result = DocumentAttribute::typeDocumentAttributeAudioSecret23;
        break;
    default:
        result = DocumentAttribute::typeDocumentAttributeImageSize;
        break;
...
void DocumentAttributeObject::coreMaskCoordsChanged() {
