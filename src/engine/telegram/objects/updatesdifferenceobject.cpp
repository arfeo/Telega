...
void UpdatesDifferenceObject::setPts(qint32 pts) {
...
qint32 UpdatesDifferenceObject::pts() const {
    return m_core.pts();
}
...
void UpdatesDifferenceObject::setClassType(quint32 classType) {
    ...
    case TypeUpdatesDifferenceTooLong:
        result = UpdatesDifference::typeUpdatesDifferenceTooLong;
        break;
    default:
        result = UpdatesDifference::typeUpdatesDifferenceEmpty;
        break;
...
quint32 UpdatesDifferenceObject::classType() const {
    ...
    case UpdatesDifference::typeUpdatesDifferenceTooLong:
        result = TypeUpdatesDifferenceTooLong;
        break;
    default:
        result = TypeUpdatesDifferenceEmpty;
        break;
