...
public:
    enum UploadFunction {
        ...
        fncUploadGetWebFile = 0x24e6818d,
        fncUploadGetCdnFile = 0x2000bcc3,
        fncUploadReuploadCdnFile = 0x2e7a2020
    };
    ...
    static bool getWebFile(OutboundPkt *out, const InputWebFileLocation &location, qint32 offset, qint32 limit);
    static UploadWebFile getWebFileResult(InboundPkt *in);

    static bool getCdnFile(OutboundPkt *out, const QByteArray &fileToken, qint32 offset, qint32 limit);
    static UploadCdnFile getCdnFileResult(InboundPkt *in);

    static bool reuploadCdnFile(OutboundPkt *out, const QByteArray &fileToken, const QByteArray &requestToken);
    static bool reuploadCdnFileResult(InboundPkt *in);
