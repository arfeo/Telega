...
public:
    enum AccountFunction {
        ...
        fncAccountSendConfirmPhoneCode = 0x1516d7bd,
        fncAccountConfirmPhone = 0x5f2178c3,
        fncAccountGetTmpPassword = 0x4a82327e
    };
    ...
    static bool sendConfirmPhoneCode(OutboundPkt *out, bool allowFlashcall, const QString &hash, bool currentNumber);
    static AuthSentCode sendConfirmPhoneCodeResult(InboundPkt *in);

    static bool confirmPhone(OutboundPkt *out, const QString &phoneCodeHash, const QString &phoneCode);
    static bool confirmPhoneResult(InboundPkt *in);

    static bool getTmpPassword(OutboundPkt *out, const QByteArray &passwordHash, qint32 period);
    static AccountTmpPassword getTmpPasswordResult(InboundPkt *in);
