...
bool Functions::Contacts::getTopPeers(OutboundPkt *out, bool correspondents, bool botsPm, bool botsInline, bool phoneCalls, bool groups, bool channels, qint32 offset, qint32 limit, qint32 hash) {
    ...
    if(phoneCalls != 0) flags = (1<<3 | flags);
