...
public:
    enum PhotosFunction {
        fncPhotosUpdateProfilePhoto = 0xf0bb5152,
        fncPhotosUploadProfilePhoto = 0x4f32c098,
    ...
    static bool updateProfilePhoto(OutboundPkt *out, const InputPhoto &id);
    static UserProfilePhoto updateProfilePhotoResult(InboundPkt *in);

    static bool uploadProfilePhoto(OutboundPkt *out, const InputFile &file);
