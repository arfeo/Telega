...
bool Functions::Account::registerDevice(OutboundPkt *out, qint32 tokenType, const QString &token) {
...
bool Functions::Account::sendConfirmPhoneCode(OutboundPkt *out, bool allowFlashcall, const QString &hash, bool currentNumber) {
    out->appendInt(fncAccountSendConfirmPhoneCode);
...
AuthSentCode Functions::Account::sendConfirmPhoneCodeResult(InboundPkt *in) {
    AuthSentCode result;
    if(!result.fetch(in)) return result;
    return result;
}

bool Functions::Account::confirmPhone(OutboundPkt *out, const QString &phoneCodeHash, const QString &phoneCode) {
    out->appendInt(fncAccountConfirmPhone);
    out->appendQString(phoneCodeHash);
    out->appendQString(phoneCode);
    return true;
}

bool Functions::Account::confirmPhoneResult(InboundPkt *in) {
    bool result;
    result = in->fetchBool();
    return result;
}

bool Functions::Account::getTmpPassword(OutboundPkt *out, const QByteArray &passwordHash, qint32 period) {
    out->appendInt(fncAccountGetTmpPassword);
    out->appendBytes(passwordHash);
    out->appendInt(period);
    return true;
}

AccountTmpPassword Functions::Account::getTmpPasswordResult(InboundPkt *in) {
