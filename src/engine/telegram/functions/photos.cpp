...
bool Functions::Photos::updateProfilePhoto(OutboundPkt *out, const InputPhoto &id) {
...
bool Functions::Photos::uploadProfilePhoto(OutboundPkt *out, const InputFile &file) {
