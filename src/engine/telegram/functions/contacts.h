...
public:
    ...
    static bool getTopPeers(OutboundPkt *out, bool correspondents, bool botsPm, bool botsInline, bool phoneCalls, bool groups, bool channels, qint32 offset, qint32 limit, qint32 hash);
